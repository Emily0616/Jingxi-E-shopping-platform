    ...
    <div class="tab-header">
      <div class="inner">
        ...
        <div class="pull-right">
          ...
          <a href="udai_welcome.html">我的京西</a>
          <a>
            Hi~
            <span class="cr">Emily</span>
          </a>
          <a href="udai_welcome.html" style="margin-left:0px;">
            <img
              src="../../static/images/icons/default_avt.png"
              alt="欢迎来到京西商城"
              class="cover upperrightlogo"
            >
          </a>
          <!-- a1为什么不对？？ -->
        </div>
      ...
      <div class="inner">
        ...
        <div class="search-box">
          <form class="input-group">
            <input placeholder="Ta们都在搜京西商城" type="text">
    ...
    <div class="top-nav bg3">
      <div class="nav-box inner">
        ...
        <ul class="nva-list">
          ...
          <a href="enterprise_id.html">
            <li>企业账号</li>
          </a>
          <a href="udai_contract.html">
            <li>诚信合约</li>
          </a>
          <a href="item_remove.html">
            <li>实时下架</li>
          </a>
        </ul>
      </div>
      ...
      <section class="item-show__div item-show__head clearfix">
        <div class="pull-left">
          <ol class="breadcrumb">
            ...
            <li>
              <a href="item_sale_page.html">爆款推荐</a>
            </li>
          ...
          <div class="item-pic__box" id="magnifier">
            <div class="small-box">
              <img
                class="cover"
                src="../../static/images/temp/S-001-1_s.jpg"
            ...
            <div class="thumbnail-box">
              ...
              <div class="thumb-list">
                <ul class="wrapper clearfix">
                  <li class="item active" data-src="../../static/images/temp/S-001-1_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-1_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-2_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-2_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-3_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-3_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-4_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-4_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-5_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-5_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-6_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-6_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-7_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-7_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-8_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-8_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-9_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-9_s.jpg" alt="商品预览图">
                  </li>
                  <li class="item" data-src="../../static/images/temp/S-001-10_b.jpg">
                    <img class="cover" src="../../static/images/temp/S-001-10_s.jpg" alt="商品预览图">
                  </li>
                </ul>
              </div>
            ...
            <div class="big-box">
              <img
                src="../../static/images/temp/S-001-1_b.jpg"
                alt="重回汉唐 旧忆 原创设计日常汉服女款绣花长褙子吊带改良宋裤春夏"
              >
            </div>
          </div>
              ...
              <div class="price-box clearfix">
                ...
                <div class="vip-price-panel pull-right">
                  ...
                  <ul class="all-price__box">
                    <!-- 登陆后可见 -->
                    <li>
                      <span class="text-justify">普通：</span>40.00元
                    </li>
                    <li>
                      <span class="text-justify">银牌：</span>38.00元
                    </li>
                    <li>
                      <span class="text-justify">超级：</span>28.00元
                    </li>
                    <li>
                      <span class="text-justify">V I P：</span>19.20元
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <dl class="item-prop clearfix">
                  ...
                  <dd>
                    <ul data-property="颜色" class="clearfix">
                      ...
                      <li>
                        <a href="javascript:;" role="button" data-value="黑色" aria-disabled="true">
                          <span>黑色</span>
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;" role="button" data-value="粉红色" aria-disabled="true">
                          <span>粉红色</span>
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;" role="button" data-value="黄色" aria-disabled="true">
                          <span>黄色</span>
                        </a>
                      </li>
                    </ul>
                ...
                <dl class="item-prop clearfix">
                  ...
                  <dd>
                    <ul data-property="尺码" class="clearfix">
                      <li>
                        <a href="javascript:;" role="button" data-value="S" aria-disabled="true">
                          <span>S</span>
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;" role="button" data-value="M" aria-disabled="true">
                          <span>M</span>
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;" role="button" data-value="L" aria-disabled="true">
                          <span>L</span>
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;" role="button" data-value="XL" aria-disabled="true">
                          <span>XL</span>
                        </a>
                      </li>
                    </ul>
          ...
          <div class="tab-content">
            ...
            >
              ...
              <div class="rich-text">
                <p style="text-align: center;">
                  ...
                  <img src="../../static/images/temp/S-001_1.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_2.jpg" alt>
                  <br>

                  <i id="desc-module-2" style="font-size: 0"></i>
                  <img src="../../static/images/temp/S-001_3.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_4.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_5.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_6.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_7.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_8.jpg" alt>
                  <br>

                  <i id="desc-module-3" style="font-size: 0"></i>
                  <img src="../../static/images/temp/S-001_9.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_10.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_11.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_12.jpg" alt>
                  <br>

                  <i id="desc-module-4" style="font-size: 0"></i>
                  <img src="../../static/images/temp/S-001_13.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_14.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_15.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_16.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_17.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_18.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_19.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_20.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_21.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_22.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_23.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_24.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_25.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_26.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_27.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_28.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_29.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_30.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_31.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_32.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_33.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_34.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_35.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_36.jpg" alt>
                  <br>

                  <i id="desc-module-5" style="font-size: 0"></i>
                  <img src="../../static/images/temp/S-001_37.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_38.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_39.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_40.jpg" alt>
                  <br>
                  <img src="../../static/images/temp/S-001_41.png" width="790" alt>
                </p>
              </div>
            </div>
                      ...
                      <div class="eval-content">
                        ...
                        <div class="eval-imgs">
                          <div class="img-temp">
                            <img
                              src="../../static/images/temp/S-001-1_s.jpg"
                              data-src="../../static/images/temp/S-001-1_b.jpg"
                              data-action="zoom"
                              class="cover"
                            >
                          </div>
                          <div class="img-temp">
                            <img
                              src="../../static/images/temp/S-001-2_s.jpg"
                              data-src="../../static/images/temp/S-001-2_b.jpg"
                              data-action="zoom"
                              class="cover"
                            >
                          </div>
                          <div class="img-temp">
                            <img
                              src="../../static/images/temp/S-001-3_s.jpg"
                              data-src="../../static/images/temp/S-001-3_b.jpg"
                              data-action="zoom"
                              class="cover"
                            >
                          </div>
                          <div class="img-temp">
                            <img
                              src="../../static/images/temp/S-001-4_s.jpg"
                              data-src="../../static/images/temp/S-001-4_b.jpg"
                              data-action="zoom"
                              class="cover"
                            >
                          </div>
                          <div class="img-temp">
                            <img
                              src="../../static/images/temp/S-001-5_s.jpg"
                              data-src="../../static/images/temp/S-001-5_b.jpg"
                              data-action="zoom"
                              class="cover"
                            >
                          </div>
                        </div>
                        <div class="eval-time">2017年08月11日 20:31 颜色分类：深棕色 尺码：均码</div>
                      </div>
                    </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="service" aria-labelledby="service-tab">
              ...
              <div class="service-content rich-text">
                ...
                >AOC 显示器实施全国范围联保，国家标准三包服务。无论您是在中国大陆 ( 不含香港、澳门、台湾地区) 何处购买并在大陆地区使用的显示器，出现三包范围内的故障时，可凭显示器的保修证正本和购机发票到 AOC 显示器维修网点或授权网点进行维修同时，也欢迎您关注官方微信服务号“AOC用户俱乐部”(微信号：aocdisplay)进行查询。</p>
                ...
                <p
                  style="text-indent:2em"
                >AOC针对各省市地区采取指定商品销售，消费者购买指定销往该区域的LUVIA卢瓦尔显示器标准品，从发票开具之日起1年内，注册成为官方微信服务号“AOC用户俱乐部”(微信号：aocdisplay)产品会员，即可在当地享“LUVIA视界头等舱，VIP专享服务”。</p>
                <div style="text-align:center">
                ...
                <p
                  style="text-indent:2em"
                >注册会员方式：1、关注“AOC用户俱乐部”微信公众号。2、点击“会员”→“注册会员”。3、填写个人真实信息并注册产品信息，即可成为AOC产品会员。</p>
                ...
                <p>注：
                  <br>(1)如不能及时提供购机发票或发票记载不清、涂改、商品实物标示和发票内容不符，将以您上传“AOC用户俱乐部”的发票信息为准计算保修时间；如果发票信息并未上传，将以该显示器制造日期(制造日期见显示器后壳条形码标签)加一个月为准计算保修时间。
                  <br>(2)非“AOC用户俱乐部”产品会员，不享受“LUVIA视界头等舱，VIP专享服务”。
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="descCate-content bgf5">
                <dd class="dc-idsItem selected">
                  <a href="#desc-module-1">
                    <i class="iconfont icon-dot"></i> 产品图
                  </a>
                </dd>
                <dd class="dc-idsItem">
                  <a href="#desc-module-2">
                    <i class="iconfont icon-selected"></i> 细节图
                  </a>
                </dd>
                <dd class="dc-idsItem">
                  <a href="#desc-module-3">
                    <i class="iconfont"></i> 尺寸及试穿
                  </a>
                </dd>
                <dd class="dc-idsItem">
                  <a href="#desc-module-4">
                    <i class="iconfont"></i> 模特效果图
                  </a>
                </dd>
                <dd class="dc-idsItem">
                  <a href="#desc-module-5">
    ...
    <div class="footer">
      ...
      <div class="copy-box clearfix">
        ...
        <p class="copyright">© 2005-2017 U袋网 版权所有，并保留所有权利
          <br>ICP备案证书号：闽ICP备16015525号-2&nbsp;&nbsp;&nbsp;&nbsp;福建省宁德市福鼎市南下村小区（锦昌阁）1栋1梯602室&nbsp;&nbsp;&nbsp;&nbsp;Tel: 18650406668&nbsp;&nbsp;&nbsp;&nbsp;E-mail: 18650406668@qq.com
        </p>
      </div>
    </div>
  </div>
...
<script>
import { magnifier } from "../../static/js/jquery.magnifier.js";
import { zoom } from "../../static/js/jquery.zoom.js";
