      ...
      <div class="inner">
        ...
        <div class="pull-right">
          ...
          <a href="udai_welcome.html" style="margin-left:0px;">
            <img src="../../static/images/icons/default_avt.png" alt="欢迎来到U袋网" class="cover upperrightlogo">
          </a>
          <!-- a1为什么不对？？ -->
        </div>
      </div>
    ...
    <div class="content clearfix bgf5">
      <section class="user-center inner clearfix">
        <div class="pull-left bgf">
          <a href="udai_welcome.html" class="title">京西欢迎页</a>
          <dl class="user-center__nav">
            <dt>帐户信息</dt>
            <a href="udai_setting.html">
              <dd class="active">个人资料</dd>
            </a>
            <a href="udai_address.html">
              <dd>收货地址</dd>
            </a>
            <a href="udai_pwd_modify.html">
              <dd>修改登录密码</dd>
            </a>
          </dl>
          <dl class="user-center__nav">
            <dt>订单中心</dt>
            <a href="udai_order.html">
              <dd>我的订单</dd>
            </a>
            <a href="udai_collection.html">
              <dd>我的收藏</dd>
            </a>
            <a href="udai_refund.html">
              <dd>退款/退货</dd>
            </a>
          </dl>
        </div>
        <div class="pull-right">
          <div class="user-content__box clearfix bgf">
            ...
            <div class="port b-r50" id="crop-avatar">
              <div class="img">
                <img src="../../static/images/icons/default_avt.png" class="cover b-r50">
              </div>
            </div>
            <form action class="user-setting__form" role="form">
              ...
              <div class="user-form-group">
                ...
                <label>
                  ...
                  <i class="iconfont icon-radio"></i> 男士
                </label>
                <label>
                  <input type="radio" name="sex" value="W">
                  <i class="iconfont icon-radio"></i> 女士
                </label>
              </div>
              <div class="user-form-group">
                <label>生日：</label>
                <label>
                  <input type="text" class="datepicker" value="1993-02-15" placeholder="请选择您的出生日期">
                </label>
              </div>
              <div class="user-form-group">
...
import { cropper } from "../../static/js/cropper/cropper.min.js";
import { sitelogo } from "../../static/js/cropper/sitelogo.js";
import { datepicker } from "../../static/js/zebra.datepicker.min.js";
...
<style scoped>
@import "../../static/my_css/cropper/cropper.min.css";
@import "../../static/my_css/cropper/sitelogo.css";
...
/* @import "../../static/my_css/zebra.datepicker.css"; */
</style>
